<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/data/www/floer/public/../application/admin/view/course/addcourse.html";i:1526012495;}*/ ?>
    ...
    <div class="row">
        <div class="col-sm-8" >
            <div class="ibox float-e-margins">
                ...
                <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('course/addCourse'); ?>">
                 ...
                 <div class="form-group">
                        ...
                        <div class="input-group col-sm-4">
                            <select name="classify_id" id="" class="form-control">
                                ...
                                <option value="<?php echo $c['id']; ?>"><?php echo $c['classify_name']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                   </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select name="teacher_id" id="" class="form-control">
                                    ...
                                    <option value="<?php echo $t['id']; ?>"><?php echo $t['name_z']; ?>(<?php echo $t['name_y']; ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input  type="text" class="form-control" required="" aria-required="true" name="courser_name">
                            </div>
                            </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">开课时间：</label>
                            <div class="input-group col-sm-4">
                                <input type="text" onfocus="WdatePicker({firstDayOfWeek:1})" id="logmin" class="form-control Wdate" style="width:120px;" name="startime" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">课程结束时间：</label>
                            <div class="input-group col-sm-7">
                                <input type="text" onfocus="WdatePicker({firstDayOfWeek:1})" id="logmin" class="form-control Wdate" style="width:120px;" name="endtime" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">上课人数：</label>
                            <div class="input-group col-sm-4">
                                <input type="text" class="form-control" required="" aria-required="true" name="courser_num">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"></label>
                            <div class="input-group col-sm-4">
                               全额价格 <input type="text" class="form-control" required="" aria-required="true" name="courser_price">
                            </div>

                            <label class="col-sm-3 control-label">课程价格：</label>
                            <div class="input-group col-sm-4">
                            定&nbsp;&nbsp;&nbsp;金<input type="text" class="form-control" required="" aria-required="true" name="depoit_price">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">课程相关介绍：</label>
                            <div class="input-group col-sm-7">
                                <textarea class=" textarea" id="answerDetail" name="courser_detail"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="ibox-content base_3" >
                    ...
                    <div style="width:400px; margin-left: auto;" id="video_div"><i class="Hui-iconfont-del layui-icon">&#xe640;</i>
                    ...
                    <div class="form-group" style="text-align: left;margin-right: 400px;">
