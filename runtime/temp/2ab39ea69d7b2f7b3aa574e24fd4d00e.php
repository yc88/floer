<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\wwwroot\floer\public/../application/admin\view\index.html";i:1524201866;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span>
                    <img alt="image" class="img-circle" src="<?php echo getImgName($head,300,150); ?>" style="width:64px;height:64px;" onerror="this.src='__NoImg__'"/>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <?php if(authCheck('user/edituserinfo')): ?>
                            <li>
             <a class="J_menuItem" href="<?php echo url('/admin/user/edituserinfo/id/'.$u_id); ?>">修改信息</a>
                            </li>
                            <?php endif; ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('admin/user/editpassword'); ?>">修改密码</a>
                            </li>
                            <li>
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <?php if(!empty($vo['son'])): if(is_array($vo['son']) || $vo['son'] instanceof \think\Collection || $vo['son'] instanceof \think\Paginator): if( count($vo['son'])==0 ) : echo "" ;else: foreach($vo['son'] as $key=>$v): ?>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                    src="<?php echo url('Index/default_index'); ?>" frameborder="0"
                    data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2018-2020 <a href="http://www.florevp.com" target="_blank">www.florevp.com</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
