<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wwwroot\floer\public/../application/admin\view\question\questionback.html";i:1526282670;}*/ ?>
        ...
        layer.ready(function(){
            ...
            if(1 == res.status){
                layer.msg(res.msg,{title: '友情提示', icon: 1, closeBtn: 0},function(){
                    window.location.href = "<?php echo url('question/index'); ?>";
                });
            }else{
