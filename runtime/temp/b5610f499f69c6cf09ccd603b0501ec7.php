<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wwwroot\floer\public/../application/admin\view\system\banner.html";i:1524107547;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('system/addbanner')): ?>
                <a href="<?php echo url('system/addbanner'); ?>"><button class="btn btn-outline btn-primary" type="button">添加banner</button></a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<?php echo url('system/banner'); ?>", //获取数据的地址
            striped: true,  //表格显示条纹
    ...
    function roleDel(id){
        layer.confirm('确认删除此banner?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('system/delbanner'); ?>", {'id' : id}, function(res){
                if(1 == res.status){
