    ...
    public function index(){
        if(request()->isAjax()){
            ...
            foreach($selectResult as $key=>$vo){
                $selectResult[$key]['user_name'] = $user->getUserName($vo['buy_id'],'user_name')['user_name'];
                ...
                $selectResult[$key]['input'] = "<input type='checkbox' value='{$vo['id']}' name='status_ok'>"; //excel educe
...
//        dump($residue);exit;
    ...
    public function orderexcel(){
      ...
      exportExcel($xlsName,$xlsCell,$result,config('fileName_save').$fileName.'.xls');
    }
